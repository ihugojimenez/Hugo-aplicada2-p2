...
namespace DAL
{
    ...
    public class ConexionDb
    {
        ...
        public ConexionDb()
        {
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["Parcial2Db"].ConnectionString));//"Data Source = ROOT - PC\\SURPUSER; Initial Catalog = HandlingQuotasDb; Integrated Security = True"
            Cmd = new SqlCommand();
        }
